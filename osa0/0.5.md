...
sequenceDiagram
    ...
    Note right of browser:Selain alkaa suorittamaan JavaScript-koodia, joka tekee http GET-pyynnön osoitteeseen https://studies.cs.helsinki.fi/exampleapp/data.json, josta muistiinpanot palautetaan JSON-muotoisena raakadatana
